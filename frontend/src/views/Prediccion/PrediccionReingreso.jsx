...
const PrediccionReingreso = () => {
  ...
  const generarExplicacionConGeminiFrontend = async (prediccionMlInfo, datosDelPaciente) => {
    ...
    const prompt_parts = [
        "Actúa como un asistente médico virtual experto usando terminos del videojuego Omori. Tu tarea es explicar usando terminos del videojuego Omori y en un solo párrafo (máximo 4 frases) el resultado de una predicción de riesgo de reingreso hospitalario a otro profesional de la salud.",
        ...
        "\nRedacta la explicación usando terminos del videojuego Omori destacando los posibles factores de los datos proporcionados que podrían ser más relevantes para este resultado. Basa tu explicación ÚNICAMENTE en la información dada. Evita especulaciones o recomendaciones médicas directas no fundamentadas en estos datos."
    ];
